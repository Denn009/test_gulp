...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_range_slider_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/range-slider.js */ "./src/js/components/range-slider.js");
...
/* harmony import */ var _components_product_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/product.js */ "./src/js/components/product.js");
...
/* harmony import */ var _components_sort_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/sort.js */ "./src/js/components/sort.js");
/* harmony import */ var _components_sort_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_components_sort_js__WEBPACK_IMPORTED_MODULE_7__);
...
/* harmony import */ var _vendor_graph_modal_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/graph-modal.min */ "./src/js/vendor/graph-modal.min.js");
/* harmony import */ var _vendor_graph_modal_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_graph_modal_min__WEBPACK_IMPORTED_MODULE_1__);
...
const navItems = nav === null || nav === void 0 ? void 0 : nav.querySelectorAll('a');
...
new simplebar__WEBPACK_IMPORTED_MODULE_0__["default"](document.getElementById('mini-cart__top'));
...
function init() {
  ...
  myMap.geoObjects.add(new ymaps.Placemark([59.94090776, 30.28289075], {
...
const prodSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.modal-slider__container', {
  slidesPerView: 1,
  spaceBetween: 20
});
if (catalogList) {
    ...
    if (item.type === 'checkbox') {
      return `
        <li class="quiz-question__item">
          <img src="../img/quiz_img.jpg" alt="">
           <label class="custom_checkbox checkbox">
            <input type="${item.type}" class="custom_checkbox_input checkbox_input" data-valid="false" name="${data.answer_alias}" ${item.type == 'text' ? 'placeholder="Введите ваш вариант"' : ''} value="${item.type !== 'text' ? item.answer_title : ''}">
            <span class="custom_checkbox_content checkbox_content">${item.answer_title}</span>
          </label>
        </li>
      `;
